package app.interfold.app.ui.compose
...
@RequiresOptIn(message = "This API is internal to Interfold's layout system. Did you mean to use LocalChildPanelsMode?", level = RequiresOptIn.Level.ERROR)
@Retention(AnnotationRetention.BINARY)
@Target(AnnotationTarget.PROPERTY)
annotation class InternalInterfoldLayoutApi

@OptIn(ExperimentalDecomposeApi::class)
@InternalInterfoldLayoutApi
