package app.interfold.app.ui.compose.theme
...
import app.interfold.app.utils.AnimationSpeed
import app.interfold.app.utils.effectsSpec
import app.interfold.app.utils.isGrayscale
import com.materialkolor.PaletteStyle
import com.materialkolor.dynamicColorScheme
import com.materialkolor.ktx.animateColorScheme

private object InterTypefaceTokens {
...
private class BaseTypeScaleTokens(
  ...
  override val BodyLargeWeight = InterTypefaceTokens.WeightRegular
  ...
  override val BodyMediumWeight = InterTypefaceTokens.WeightRegular
  ...
  override val BodySmallWeight = InterTypefaceTokens.WeightRegular
  ...
  override val DisplayLargeWeight = InterTypefaceTokens.WeightMedium
  ...
  override val DisplayMediumWeight = InterTypefaceTokens.WeightMedium
  ...
  override val DisplaySmallWeight = InterTypefaceTokens.WeightMedium
  ...
  override val HeadlineLargeWeight = InterTypefaceTokens.WeightMedium
  ...
  override val HeadlineMediumWeight = InterTypefaceTokens.WeightMedium
  ...
  override val HeadlineSmallWeight = InterTypefaceTokens.WeightMedium
  ...
  override val LabelLargeWeight = InterTypefaceTokens.WeightMedium
  ...
  override val LabelMediumWeight = InterTypefaceTokens.WeightMedium
  ...
  override val LabelSmallWeight = InterTypefaceTokens.WeightMedium
  ...
  override val TitleLargeWeight = InterTypefaceTokens.WeightMedium
  ...
  override val TitleMediumWeight = InterTypefaceTokens.WeightMedium
  ...
  override val TitleSmallWeight = InterTypefaceTokens.WeightMedium
}
...
private class InterTypographyTokens(
...
fun generateTypography(fontChoice: FontChoice, fontSizeScalar: FontSizeScalar): Typography {
  ...
  val tokens = InterTypographyTokens(typeScaleTokens)
...
val LocalInterTypography = staticCompositionLocalOf<Typography> {
  error("No InterTypography provided")
}

val LocalInterShapes = staticCompositionLocalOf<Shapes> {
  error("No InterShapes provided")
}
...
fun InterTheme(
  ...
  CompositionLocalProvider(
    LocalInterTypography provides typography,
    LocalInterShapes provides shapes
  ) {
    MaterialTheme(
      colorScheme = scheme,
...
fun ThemeFromColor(
  ...
  val typography = LocalInterTypography.current
  val shapes = LocalInterShapes.current
  ...
  /*if (color == null || isGrayscale(color) || alterColorType == AlterColorType.NONE) {
    ...
    MaterialTheme(
      ...
      typography = interfoldTypography,
      content = content
    )
  }*/
}
