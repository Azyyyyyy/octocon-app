...
import app.interfold.app.ui.compose.screens.main.polls.PollListScreen
import app.interfold.app.ui.compose.screens.main.polls.PollViewScreen
...
import interfoldapp.shared.resources.select_poll_placeholder
...
fun PollsScreen(
  ...
  DoublePanels(
    ...
    main = { PollListScreen(it.instance) },
    details = { PollViewScreen(it.instance) },
    reduceMotion = reduceMotion,
    placeholder = { PollPanelPlaceholder(reduceMotion) },
  )
}

@Composable
private fun PollPanelPlaceholder(reduceMotion: Boolean) {
    ...
    Box(
      ...
      Card(
        ...
        Column(
          ...
          Text(Res.string.select_poll_placeholder.compose)
        }
      }
    }
  }
