...
import app.interfold.app.ui.compose.components.GlobalJournalEntryCard
...
import interfoldapp.shared.resources.permanent_tip_global_journals
...
fun JournalEntryListScreen(
  ...
  InterScaffold(
    ...
    floatingActionButton = {
      if (!ready || settings.encryptedEncryptionKey == null) return@InterScaffold
      Column(
