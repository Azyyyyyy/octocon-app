...
@JsFun(
  "() => { " +
    ...
    "if (messaging.__octoconOnMessageBound) return true; " +
    "messaging.__octoconOnMessageBound = true; " +
    ...
    "new Notification(title, { body: body, icon: '/icons/icon-192.png', tag: 'octocon-fg' }); " +
    "} " +
    "} catch (e) { console.warn('[Octocon Push] Foreground handler failed:', e); } " +
    "}); " +
    "return true; " +
    "}"
)
