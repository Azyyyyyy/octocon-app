package app.interfold.color_picker.harmony
...
import app.interfold.color_picker.toDegree
...
private fun HarmonyColorPickerWithMagnifiers(
  ...
  BoxWithConstraints(
    ...
    fun updateColorWheel(newPosition: Offset, animate: Boolean) {
      ...
      val newColor =
        colorForPosition(newPosition, IntSize(diameterPx, diameterPx), hsvColorUpdated.value)
      if (newColor != null) {
